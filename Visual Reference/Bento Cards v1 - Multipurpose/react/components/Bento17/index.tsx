    ...
    <div className={styles.bento}>
        ...
        <div className={styles.body}>
            <div className={styles.row}>
                <div className={styles.col}>
                    ...
                    <div className={styles.balls}>
                        <Image
                            src="/images/bento-17-balls-1.svg"
                            width={40}
                            height={58}
                            alt=""
                        />
                ...
                <div className={styles.col}>
                    ...
                    <div className={styles.balls}>
                        <Image
                            src="/images/bento-17-balls-2.svg"
                            width={40}
                            height={28}
                            alt=""
                        />
                ...
                <div className={styles.col}>
                    ...
                    <div className={styles.balls}>
                        <Image
                            src="/images/bento-17-balls-3.svg"
                            width={43}
                            height={91}
                            alt=""
                        />
                ...
                <div className={styles.col}>
                    ...
                    <div className={styles.balls}>
                        <Image
                            src="/images/bento-17-balls-4.svg"
                            width={45}
                            height={36}
                            alt=""
                        />
            ...
            <div className={styles.marker}>
                <Image
                    src="/images/bento-17-marker.svg"
                    width={15}
                    height={14}
                    alt=""
                />
